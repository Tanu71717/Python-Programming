...
from collections import defaultdict  # 대현이 한테 물어봄
...
subjects = ["국어", "영어", "수학"]
grades = [90, 80, 100]
a = dict(zip(subjects, grades))
print(a)
tuple = {"연필": 10, "지우개": 5, "노트": 3}  # 기존 재고
i = {"지우개": 4, "노트": 7, "볼펜": 12}  # 입고 내역
t.update({item: t.get(item, 0) + k for item, k in i.items()})

print(stock)


# 아ㅏㅏㅏㅏㅏㅏㅏㅏㅏ하기싫다ㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏㅏ
